...
r6   = 0xbe8849a0, r7   = 0x0000003f
r8   = 0x00000034, r9   = 0x41424ec0
r10  = 0x41454719, fp   = 0xbe884994
ip   = 0x00000000, sp   = 0xbe884430
...
419f9000 41a00000 rw-p [heap]
41a00000 41b32000 rw-p [heap]
41b32000 41b38000 r-xp /usr/lib/libwidget_provider_app.so.1.0.0
41b40000 41b46000 r-xp /usr/lib/libwidget.so.1.0.0
41b4f000 41b54000 r-xp /usr/lib/libcapi-system-info.so.0.2.0
430e3000 430ec000 r-xp /usr/lib/libcom-core.so.0.0.1
430f5000 43101000 r-xp /usr/lib/libwidget_service.so.1.0.0
43109000 43112000 r-xp /usr/lib/libwidget_provider.so.1.0.0
4311b000 43123000 r-xp /usr/lib/libdrm.so.2.4.0
4312b000 43132000 r-xp /usr/lib/libtbm.so.1.0.0
4356c000 43d6b000 rw-p [stack:28170]
43d6b000 43d6e000 r-xp /usr/lib/evas/modules/engines/buffer/linux-gnueabi-armv7l-1.7.99/module.so
...
be865000 be886000 rw-p [stack]
End of Maps Information

Callstack Information (PID:28098)
Call Stack Count: 1
...
viewer-data-provider.cpp: AddPendingChanges(1053) > added [79] to pending list
...
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [27]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [13]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [6]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [28]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [28]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [28] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [13]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [13]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [13] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [73]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [73]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [73] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [30]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [30]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [30] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [3]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [3]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [3] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [27]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [27]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [27] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [6]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [6]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [6] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [74]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [74]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [74] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [75]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [75]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [75] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [76]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [76]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: AddPendingChanges(1053) > added [76] to pending list
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: FlushPendingChanges(1064) > notify pending [77]
12-07 22:10:00.959+0900 I/watchface-viewer(28265): viewer-data-provider.cpp: NotifyListeners(617) > dummy mode!! ignored!! [77]
...
12-07 22:10:03.929+0900 W/CRASH_MANAGER(27967): worker.c: worker_job(1199) > 1128098626c61144949379
